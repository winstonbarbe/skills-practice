...
p convert_array_into_hash(array_of_hashes)
...
def convert_string_into_hash_count(string)
  split_string = string.split('')
  split_string_hashes = {}
  split_string.each do |letter|
    split_string_hashes[letter] = 1
  end
  
end


convert_string_into_hash_count("bookkeeper")
